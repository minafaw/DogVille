...
public class DogsAdapter extends ArrayAdapter<DogsModel>{

    Context context ;
    int layoutResourceId;
    DogsModel data[] = null;

    public DogsAdapter(Context context , int layoutResourceId ,DogsModel[] data)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        DogsModel product = data[position];
        holder.name.setText(product.getDogName());
